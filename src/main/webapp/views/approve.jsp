	  					...
	  					<div class="col">
						    <div class="card h-100">
						      ...
						      <div class="card-footer text-center">
						      	<a class="btn btn-sm btn-outline-dark col-md-5" href="/admin/approve/<%= classified.getClassifiedId() %>">Approve</a>
						      	<a class="btn btn-sm btn-outline-dark col-md-5" href="/admin/reject/<%= classified.getClassifiedId() %>">Reject</a>
						      </div>
	    					</div>
  						</div>
	  				<% } %>
