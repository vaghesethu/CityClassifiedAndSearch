...
<title>edit classified page</title>
...
<form>
    <div class="container">
      <h1>Post Classified</h1>
		...
		<select id="classifiedCategory" name="classifiedCategory" class="btn btn-secondary dropdown-toggle"
		...
		<input type="text" id="description" value="" name="description" required ><br></br>
